...
export PATH=$PATH:$ANDROID_TOOLS:$ANDROID_PLATFORM_TOOLS:$HOME_BIN

MAIN_PROJECT=project #fill in your main project
...
# automatic JAVA_HOME variable
ALT_JAVA=$(readlink /etc/alternatives/java)
ALT_JAVA=${ALT_JAVA%"/jre/bin/java"}

export JAVA_HOME=$ALT_JAVA

# workaround for messed up Qt apps
